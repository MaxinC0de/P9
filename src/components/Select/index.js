...
// onChange n'a pas de valeur. On y ajoute donc newValue. onChange est un event handler qui se déclenche et se met à jour en cas de changement dans le champ de saisie. 
// fonctionnement : montrer le déroulé 
...
const Select = ({
  ...
  const changeValue = (newValue) => {
    onChange(newValue); // problem here
    setValue(newValue);
